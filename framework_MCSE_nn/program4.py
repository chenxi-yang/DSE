...
if MODE == 5:
    ...
    if DOMAIN == "zonotope":
        def initialization(x_l, x_r):
            ...
            symbol_table['h1'] = domain.Interval(-x_r[0], -x_l[0]).getZonotope()
...
def initialization_smooth_point(x, y):
    if DOMAIN == "interval":
        symbol_table = dict()
        symbol_table['h0'] = domain.Interval(var(x[0]),  var(x[0]))
        symbol_table['h1'] = domain.Interval(var(-x[0]),  var(-x[0]))
        symbol_table['v0'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['t_down'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['t_up'] = domain.Interval(var(0.0), var(0.0))
...
def construct_syntax_tree(Theta):
    ...
    # l9 = Assign(['i'], f9, l10)
    l8_0 = Assign(['x_max', 'h0'], f_max_domain, l10)
    l8 = Assign(['x_min', 'h0'], f_min_domain, l8_0)
...
def construct_syntax_tree_point(Theta):
    ...
    l8_0 = AssignPoint(['x_max', 'h0'], f_max, l10)
    l8 = AssignPoint(['x_min', 'h0'], f_min, l8_0)
...
def construct_syntax_tree_smooth_point(Theta):
    ...
    l8_0 = AssignPointSmooth(['x_max', 'h0'], f_max, l10)
    l8 = AssignPointSmooth(['x_min', 'h0'], f_min, l8_0)
