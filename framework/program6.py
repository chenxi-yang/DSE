...
def construct_syntax_tree(Theta):
    ...
    l30 = Assign(['stage'], f_stage_3, None)
    l29 = Ifelse('u', Theta, fself, l30, l31, None)
    l28 = Assign(['s', 'u'], f28, l29)
    l27 = Assign(['v'], f27, l28)
    l26 = Assign(['w'], f26, l27)
    l25 = Assign(['u', 'v', 'w', 's'], f25, l26)
