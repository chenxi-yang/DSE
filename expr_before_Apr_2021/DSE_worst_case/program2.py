...
def initialization_smooth_point(x, y):
    if DOMAIN == "interval":
        ...
        symbol_table['v1'] = domain.Interval(var(x[0]), var(x[0]))
        symbol_table['v2'] = domain.Interval(var(x[1]), var(x[1]))
        symbol_table['stage'] = domain.Interval(var(0.5), var(0.5))
        symbol_table['steps'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['x1'] = domain.Interval(var(6.0), var(6.0))
        symbol_table['y1'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['x2'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['y2'] = domain.Interval(var(4.0), var(4.0))
        symbol_table['dist'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['x_dist'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['y_dist'] = domain.Interval(var(0.0), var(0.0))
        symbol_table['x'] = domain.Interval(var(0.0), var(0.0))
