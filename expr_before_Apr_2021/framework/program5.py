...
def construct_syntax_tree(Theta):
    ...
    l18_0 = Assign(['x_neg', 'x'], f_neg, None)

    l8_0 = Assign(['isOn'], f8, None)
    l10_0 = Assign(['isOn'], f10, None)
    l7_0 = Ifelse('x', Theta, fself, l8_0, l10_0, None)

    l6_0 = Assign(['x'], f6, l7_0)

    l14_0 = Assign(['isOn'], f8, None)
    l16_0 = Assign(['isOn'], f10, None)
    l13_0 = Ifelse('x', var(77.0), fself, l14_0, l16_0, None)

    l12_0 = Assign(['x'], f12, l13_0)
    l5_0 = Ifelse('isOn', var(0.5), fself, l6_0, l12_0, l18_0)
...
def construct_syntax_tree_point(Theta):
    ...
    l5_0 = IfelsePoint('isOn', var(0.5), fself, l6_0, l12_0, l18_0)
...
def construct_syntax_tree_smooth_point(Theta):
    ...
    l5_0 = IfelsePointSmooth('isOn', var(0.5), fself, l6_0, l12_0, l18_0)
