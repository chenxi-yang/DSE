...
if MODE == 5:
    ...
    from dse_exp_propagation import *

    if DOMAIN == "interval":
        def initialization(x_l, x_r, X_train):
            ...
            # ! no sampling
            symbol_table = build_point_cloud(symbol_table, X_train, initialization_smooth_point)
            symbol_table_list.append(symbol_table)
...
def initialization_smooth_point(x, y=None):
    if DOMAIN == "interval":
        # symbol_table_list = list()
        symbol_table = dict()
...
def construct_syntax_tree(Theta):
    ...
    l13 = Ifelse('x', [var(80.0)], fself_0, l14, l16, None)

    l12 = Assign(['x', 'lin'], f12_domain, l13)
    l5 = Ifelse('isOn', [var(0.5)], fself_0, l6, l12, l18)
...
def construct_syntax_tree_point_generate(Theta):
    ...
    l13 = IfelsePoint('x', [var(80.0)], fself_0, l14, l16, None)

    l12 = AssignPoint(['x', 'lin'], f12, l13)
    l5 = IfelsePoint('isOn', [var(0.5)], fself_0, l6, l12, l18)
...
def construct_syntax_tree_smooth_point(Theta):
    ...
    l13 = IfelsePointSmooth('x', [var(80.0)], fself_0, l14, l16, None)

    l12 = AssignPointSmooth(['x', 'lin'], f12, l13)
    l5 = IfelsePointSmooth('isOn', [var(0.5)], fself_0, l6, l12, l18)
